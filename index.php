            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="create.php" class="btn btn-sucess pull-right">Novo Empregado</a>
                    </div>
                    <?php 
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<p class='lead'><em>Nenhum registro.</em></p>";
                            } 
                        }else{
                            echo "ERROR: Nao foi possivel executar a sql: $sql. " . mysqli_error($link);
                        }
